...
a5[ind_14] = 0.5
a = c(rep(1.5,m),a2,rep(c(1.4,0.7),m), a5)
```
...
set.seed(1971)
theta_chain_10000 = componentwisemixedMH(a, a_sigma = 2, beta_0 = starting_beta, sigma_0, cov_0, nrep=10000)

a_rate_10000 = apply(theta_chain_10000, MARGIN = 2, numunique)/10000
a_rate_matrix_10000 = matrix(a_rate_10000[1:n_beta], ncol = 5)
range(a_rate_matrix_10000)
which(a_rate_matrix_10000[,5]>0.7)
which(a_rate_matrix_10000[,5]<0.3)
a_rate_10000[3411]
...
colnames(theta_chain_10000) = names
colnames(theta_chain_20000) = names
colnames(theta_chain_100000) = names
## save results
save(theta_chain_10000, file = "mcmc_chain.RData")
save(theta_chain_20000, file = "mcmc_chain_20000.RData")
save(theta_chain_100000, file = "mcmc_chain_100000.RData")

theta_chain_1 = theta_chain_10000[1:1900,]
theta_chain_2 = theta_chain_10000[1901:3600,]
theta_chain_3 = theta_chain_10000[3601:5200,]
theta_chain_4 = theta_chain_10000[5201:6800,]
theta_chain_5 = theta_chain_10000[6801:8400,]
theta_chain_6 = theta_chain_10000[8401:10000,]
...
theta_chain_df = as_tibble(theta_chain_10000)
...
load("mcmc_chain_100000.RData")
## acceptance rate

a_rate = apply(theta_chain_10000, MARGIN = 2, numunique)/10000
...
```{r}
a_rate_50000 = apply(theta_chain_50000, MARGIN = 2, numunique)/50000

a_rate_matrix_50000 = matrix(a_rate_50000[1:n_beta], ncol = 5)

a_range_50000 = range(a_rate_50000)
a_0_range_50000 = range(a_rate_matrix_50000[,1])
a_sigma_50000 = a_rate_50000[sigma_ind]
...
theta_trace_inverse = apply(theta_chain_comp, 1, trace_inverse)
par(mfrow=c(3,4))
plot(theta_chain_comp[,3406], type = "l")
plot(theta_chain_comp[,3407], type = "l")
plot(theta_chain_comp[,3408], type = "l")
plot(theta_chain_comp[,3409], type = "l")
plot(theta_chain_comp[,3410], type = "l")
plot(theta_chain_comp[,3411], type = "l")
plot(theta_trace_inverse, type = "l")
plot(theta_chain_comp[,2], type = "l")
plot(theta_chain_comp[,m+2], type = "l")
plot(theta_chain_comp[,m*2+2], type = "l")
plot(theta_chain_comp[,m*3+2], type = "l")
plot(theta_chain_comp[,m*4+2], type = "l")

par(mfrow=c(3,4))
acf(theta_chain_30000[,3406])
acf(theta_chain_30000[,3407])
acf(theta_chain_30000[25001:30000,3408])
acf(theta_chain_30000[25001:30000,3409])
acf(theta_chain_30000[25001:30000,3410])
acf(theta_chain_30000[25001:30000,3411])
acf(theta_trace_inverse[25001:30000])
acf(theta_chain_30000[25001:30000,2])
acf(theta_chain_30000[25001:30000,m+2])
acf(theta_chain_30000[25001:30000,m*2+2])
acf(theta_chain_30000[25001:30000,m*3+2])
acf(theta_chain_30000[25001:30000,m*4+2])

theta_trace_inverse_50000 = apply(theta_chain_50000, 1, trace_inverse)

par(mfrow=c(3,4))
plot(theta_chain_50000[,3406], type = "l")
plot(theta_chain_50000[,3407], type = "l")
plot(theta_chain_50000[,3408], type = "l")
plot(theta_chain_50000[,3409], type = "l")
plot(theta_chain_50000[,3410], type = "l")
plot(theta_chain_50000[,3411], type = "l")
plot(theta_trace_inverse_50000, type = "l")
plot(theta_chain_50000[,2], type = "l")
plot(theta_chain_50000[,m+2], type = "l")
plot(theta_chain_50000[,m*2+2], type = "l")
plot(theta_chain_50000[,m*3+2], type = "l")
plot(theta_chain_50000[,m*4+2], type = "l")

par(mfrow=c(3,4))
acf(theta_chain_50000[45001:50000,3406])
acf(theta_chain_50000[45001:50000,3407])
acf(theta_chain_50000[45001:50000,3408])
acf(theta_chain_50000[45001:50000,3409])
acf(theta_chain_50000[45001:50000,3410])
acf(theta_chain_50000[45001:50000,3411])
acf(theta_trace_inverse_50000[45001:50000])
acf(theta_chain_50000[45001:50000,2])
acf(theta_chain_50000[45001:50000,m+2])
acf(theta_chain_50000[45001:50000,m*2+2])
acf(theta_chain_50000[45001:50000,m*3+2])
acf(theta_chain_50000[45001:50000,m*4+2])
```
...
bs_estimates = unname(apply(theta_chai10000[5001:10000,], 2, mean))
...
cov_m_100000 = solve(inv_cov_m_100000)
...
dt_res_5 = dt_res %>% 
  dplyr::select(id, nature, season, month,beta_0:beta_4) %>% 
  mutate(decades = (season-min(season))/10) %>% 
  group_by(id) %>% slice(1)
dt_res_5 %>% 
  ggplot(aes(y = beta_2, x = decades))+ 
  geom_point()

dt_res_5 %>% 
  mutate(month = reorder(month, beta_0)) %>% 
  ggplot(aes(x = beta_0))+ 
  geom_density()+

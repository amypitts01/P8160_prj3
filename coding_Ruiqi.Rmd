...
which(a_rate_matrix[,4]>0.7)
which(a_rate_matrix[,4]<0.3)

which(a_rate_matrix[,3]>0.7)
which(a_rate_matrix[,3]<0.3)
a_rate[3411]
...
bs_estimates = unname(apply(theta_chain[6001:10000,], 2, mean))

...
# specify a_1_i
a2 = rep(0.06,m)
ind_1 = c(102,323,266,458,619,630)
ind_08 = c(8,13,38,44,63,64,66,72,80,84,87,115,130,137,145,149,159,164,165,186,194,196,204,207,218,223,234,236,238,243,246,251,254,260,268,288,290,291,294,324,325,326,330,334,336,354,368,370,377,378,380,387,395,398,401,423,428,429,432,437,451,454,457,460,469,480,482,487,488,491,495,504,505,510,517,520,526,527,534,537,539,545,547,551,570,575,583,596,595,599,602,603,609,610,612,623,624,637,640,641,648,660,665,666)
...
# diagonal:3,55,5,5,6
# off_diagnol:3-15
a = c(rep(0.1, m),a2,rep(c(0.07,0.07,0.07), each = m),0.03,0.005,0.02,0.02,0.02, 1, 3,10,3,3,4,55,15,15,15,5,3,5,5,5,8)
```
...
bs_estimates = unname(apply(theta_chain[5001:10000,], 2, mean))

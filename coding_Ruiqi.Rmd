...
n_beta = nrow(df_mcmc)*d ## total number of beta
n_theta = 3426 ## total number of parameters
...
```{r}
## starting value: lm on all obs and get the coefficient as initial value for beta and mu
## get the mse of the lm as the initial value for sigma
...
set.seed(2022)
theta_chain = blockwiseMH(a, theta_0, nrep=10000, n_theta) ## generate mcmc chain 10000
theta_chain_20000 = blockwiseMH(a, theta_0, nrep=20000, n_theta) ## generate mcmc chain 20000
...
a_sigma = a_rate[n_beta+6]
a_cov_range = range(a_rate[3412:3426])
...
hist(theta_chain[5001:10000,681+2], nclass = 100)
hist(theta_chain[5001:10000,681*2+2], nclass = 100)
hist(theta_chain[5001:10000,681*3+2], nclass = 100)
hist(theta_chain[5001:10000,681*4+2], nclass = 100)
...
## adj r-square and r-sqaure are 0.96
